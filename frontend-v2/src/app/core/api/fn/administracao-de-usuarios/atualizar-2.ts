...
export function atualizar2(http: HttpClient, rootUrl: string, params: Atualizar2$Params, context?: HttpContext): Observable<StrictHttpResponse<UserAdminOutput>> {
...
atualizar2.PATH = '/api/admin/users/{userId}';
