...
@Component({
    ...
    template: `<a class="flex items-center" routerLink="/">
            <svg class="text-primary" style="width: 2.5rem; height: 2.5rem;" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-bold text-2xl leading-normal ml-2 mr-20">LINVE</span>
        </a>
        ...
        <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
            <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                <li>
                    <a (click)="scrollToSection('hero')" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Início</span>
                    </a>
                </li>
                <li>
                    <a (click)="scrollToSection('features')" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Funcionalidades</span>
                    </a>
                </li>
                <li>
                    <a (click)="scrollToSection('highlights')" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Destaques</span>
                    </a>
                </li>
                <li>
                    <a (click)="scrollToSection('pricing')" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Preços</span>
                    </a>
                </li>
            </ul>
            <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                ...
                <button pButton pRipple label="Criar Conta" routerLink="/auth/register" [rounded]="true"></button>
