...
export function listar3(http: HttpClient, rootUrl: string, params?: Listar3$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CategoriaOutput>>> {
