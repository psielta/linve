-- =====================================================
-- V0012 - Criar tabelas UF e MUNICIPIO
-- Data: 2025-11-30
-- Descricao: Cria tabelas de UFs e Municipios brasileiros
-- =====================================================

-- -----------------------------------------------------
-- Tabela UF (Unidades Federativas)
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS UF (
    UF_CD INTEGER PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS MUNICIPIO (
    MUNI_CD INTEGER PRIMARY KEY,
    MUNI_NOME VARCHAR(100) NOT NULL,
    MUNI_UF_CD INTEGER NOT NULL,
    CONSTRAINT FK_MUNICIPIO_UF FOREIGN KEY (MUNI_UF_CD) REFERENCES UF(UF_CD)
);

-- Index para consultas por UF
CREATE INDEX IF NOT EXISTS IDX_MUNICIPIO_UF ON MUNICIPIO(MUNI_UF_CD);
